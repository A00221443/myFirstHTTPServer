...
var consolere = require('console-remote-client').connect('console.re','80','A00221443_first_server');

//We need a function which handles requests and send response
function handleRequest(request, response){
    response.end('Help Im trapped inside a computer! Path Hit: ' + server_ip_address + ":" + server_port + "/" + request.url);
